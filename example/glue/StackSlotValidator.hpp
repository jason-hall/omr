...
private:
	...
	omrobjectptr_t const _slotValue; /**< The object in the stack slot being validated */
...
public:
	 ...
	 */
	MM_StackSlotValidator(UDATA flags, omrobjectptr_t slotValue, const void* stackLocation, void *walkState)
		: MM_Validator()
		, _flags(flags)
