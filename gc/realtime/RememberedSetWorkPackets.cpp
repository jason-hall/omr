...
MM_RememberedSetWorkPackets::newInstance(MM_EnvironmentBase *env, MM_WorkPacketsRealtime *workPackets)
{
	...
	rememberedSet = (MM_RememberedSetWorkPackets *)env->getForge()->allocate(sizeof(MM_RememberedSetWorkPackets), MM_AllocationCategory::WORK_PACKETS, OMR_GET_CALLSITE());
