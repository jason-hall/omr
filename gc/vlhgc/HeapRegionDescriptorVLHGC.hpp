...
public:
	 ...
	 * @return the list
	 */
	// OMRTODO MM_UnfinalizedObjectList *getUnfinalizedObjectList() { return &_unfinalizedObjectList; }
	 ...
	 * @return the list
	 */
	// OMRTODO MM_ReferenceObjectList *getReferenceObjectList() { return &_referenceObjectList; }
