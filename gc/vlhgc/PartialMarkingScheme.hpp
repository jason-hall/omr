...
private:
	 ...
	 */
	// OMRTODO MMINLINE void addOwnableSynchronizerObjectInList(MM_EnvironmentVLHGC *env, fomrobject_t object);
	 ...
	 * @param reason a code indicating why the object is being scanned
	 */
	// OMRTODO void scanClassObject(MM_EnvironmentVLHGC *env, fomrobject_t *objectPtr, ScanReason reason);
	 ...
	 * @param reason a code indicating why the object is being scanned
	 */
	// OMRTODO void scanClassLoaderObject(MM_EnvironmentVLHGC *env, fomrobject_t *objectPtr, ScanReason reason);
	 ...
	 * @param reason a code indicating why the object is being scanned
	 */
	// OMRTODO void scanClassLoaderSlots(MM_EnvironmentVLHGC *env, J9ClassLoader *classLoaderObject, ScanReason reason = SCAN_REASON_PACKET);
	 ...
	 * @param reason a code indicating why the object is being scanned
	 */
	void scanReferenceMixedObject(MM_EnvironmentVLHGC *env, omrobjectptr_t objectPtr, ScanReason reason);
	 ...
	 */
	// OMRTODO MMINLINE void markObjectClass(MM_EnvironmentVLHGC *env, fomrobject_t *objectPtr);
