...
private:
	...
	fomrobject_t *_spine; /**< If this region contains an arraylet leaf, this points to the the spine which owns the leaf */
...
public:
	...
	fomrobject_t *getSpine() { return _spine; }
	void setSpine(fomrobject_t *spineObject);
