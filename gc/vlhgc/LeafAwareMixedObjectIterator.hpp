...
private:
	...
	fomrobject_t *_objectPtr;		/**< save address of object this class initiated with */
...
public:
	...
	GC_LeafAwareMixedObjectIterator (OMR_VM *vm, fomrobject_t *objectPtr)
		...
		, _leafDescription(0)
	  {
		...
		_endPtr = (fomrobject_t *)((U_8*)_scanPtr +clazzPtr->totalInstanceSize);
	  }
};
