...
{
	MM_IncrementalCardTable *cardTable = (MM_IncrementalCardTable *)env->getForge()->allocate(sizeof(MM_IncrementalCardTable), MM_AllocationCategory::FIXED, OMR_GET_CALLSITE());
	if (NULL != cardTable) {
