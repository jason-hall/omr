...
private:
	 ...
	 * @param reason a code indicating why the object is being scanned
	 */
	void scanClassObject(MM_EnvironmentVLHGC *env, fomrobject_t *objectPtr, ScanReason reason);
	 ...
	 * @param reason a code indicating why the object is being scanned
	 */
	void scanClassLoaderObject(MM_EnvironmentVLHGC *env, fomrobject_t *objectPtr, ScanReason reason);
