...
{
private:
	MM_GCExtensionsBase * const _extensions; /**< cached pointer to the extensions structure */
...
public:
	 ...
	 */
	void rememberInstance(MM_EnvironmentBase* env, fomrobject_t* object);
	 ...
	 */
	bool isInstanceRemembered(MM_EnvironmentBase *env, fomrobject_t* object);
