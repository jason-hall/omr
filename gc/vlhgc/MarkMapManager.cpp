...
MM_MarkMapManager::newInstance(MM_EnvironmentVLHGC *env)
{
	...
	markMapManager = (MM_MarkMapManager *)env->getForge()->allocate(sizeof(MM_MarkMapManager), MM_AllocationCategory::FIXED, OMR_GET_CALLSITE());
...
bool
MM_MarkMapManager::collectorStartup(MM_GCExtensionsBase *extensions)
{
	bool result = true;
