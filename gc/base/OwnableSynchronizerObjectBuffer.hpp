...
private:
protected:
	omrobjectptr_t _head; /**< the head of the linked list of OwnableSynchronizer objects */
	omrobjectptr_t _tail; /**< the tail of the linked list of OwnableSynchronizer objects */
	...
	MM_GCExtensionsBase* const _extensions; /**< a cached pointer to the extensions structure */
public:
...
public:
	 ...
	 */
	void add(MM_EnvironmentBase* env, omrobjectptr_t object);
	 ...
	 */
	MM_OwnableSynchronizerObjectBuffer(MM_GCExtensionsBase* extensions, UDATA maxObjectCount);
};
