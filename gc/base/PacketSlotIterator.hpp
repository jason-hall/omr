...
private:
	...
	omrobjectptr_t *_nextSlot;                        /**< Next slot in the packet to be returned */
...
public:
	 ...
	 */
	void resetSplitTagIndexForObject(omrobjectptr_t correspondingObject, UDATA newValue);
	...
	MM_PacketSlotIterator(MM_Packet *packet)
		: MM_BaseNonVirtual()
		, _packet(packet)
		, _nextSlot((omrobjectptr_t *)packet->_basePtr)
	{
