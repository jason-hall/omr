...
public:
	...
	// OMRTODO class MM_ClassUnloadStats _classUnloadStats;  /**< Stats for class unload operations of the increment */
...
public:
	...
	MMINLINE void clear()
	{
		...
		// OMRTODO _classUnloadStats.clear();
		_irrsStats.clear();
		_globalMarkIncrementType = MM_VLHGCIncrementStats::mark_idle;
	}
